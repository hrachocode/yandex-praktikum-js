...
/* *ОБЩИЙ КОММЕНТАРИЙ *
      ...
      В целом отличная работа, ни одного критического замечания по структуре и функционалу нет.

      Есть пара неиспользуемых методов в классах, но это не критично и легко исправить 5-минутным рефакторингом.
      Также местами сделано не совсем так, как написано в инструкции к работе, но я не думаю, что это скорее даже плюс чем минус, видно что человек мыслит самостоятельно.
      Сборка бандла через webpack сделана хорошо и лаконично, без лишних усложнений.
